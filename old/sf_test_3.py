...
if __name__ == '__main__':
    ...
    sec_vec = range(2)
    #print sec_vec
    t_vec = ts.utc(t.utc_datetime().year,
    ...
    print 'position', gs_rv.position.km
    print 'velocity', gs_rv.velocity.km_per_s
    ...
    print 'Spacecraft:'
    print '  position', sc_rv.position.km
    print '  velocity', sc_rv.velocity.km_per_s

    del_r = sc_rv.position.km - gs_rv.position.km
    del_v = sc_rv.velocity.km_per_s - gs_rv.velocity.km_per_s

    print '  del_r', del_r
    print '  mag_r', numpy.linalg.norm(del_r)
    print '  del_v', del_v
    print '  mag_v', numpy.linalg.norm(del_v)
    ...
    #print "range", rho.km
    print "Delta:"
    r = state_vector.position.km
    v = state_vector.velocity.km_per_s
    print '  r', r
    print '  v', v
    print '  mag_r', numpy.linalg.norm(r)
    print '  mag_v', numpy.linalg.norm(v)

    r_dot = numpy.dot(r,v) / numpy.linalg.norm(r)
    print '  r_dot', r_dot
